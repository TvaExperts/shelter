...
const render3PetCardsToDom = () => {
    ...
    generate3PetCards(_js_pets_data__WEBPACK_IMPORTED_MODULE_2__.petsArr).forEach(petData => {
...
const generate3PetCards = (data) => {
    let petCards = [];
    for (let i=0; i < 3; i++) {
        petCards.push(new _js_petCard__WEBPACK_IMPORTED_MODULE_1__.PetCard(data[i]))
    }
    return petCards;
}
